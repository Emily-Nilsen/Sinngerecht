...
export function Hero() {
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      {/* I added my-16: */}
      <p className="max-w-2xl mx-auto my-16 mt-6 text-lg tracking-tight text-slate-700">
        Bereiten Sie sich auf den Start von{' '}
        <span className="font-bold">Sinngerecht</span> vor:
      </p>
      {/* I added my-16: */}
      <h1 className="max-w-4xl mx-auto my-16 text-5xl font-medium tracking-tight font-display text-slate-900 sm:text-7xl">
        Bald{' '}
        <span className="relative text-blue-600 whitespace-nowrap">
          ...
          <span className="relative">verfügbar!</span>
        </span>{' '}
